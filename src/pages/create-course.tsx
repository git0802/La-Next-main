...
function CreateQuizPage() {
  ...
  function createCourse() {
    if (description) router.push(`/course?description=${encodeURIComponent(description)}`); else showModal("enter-course-description");
  }
        ...
        <div className=" px-4 py-20 sm:px-6 lg:px-8 lg:py-6">
          ...
          <div className="col-span-full ">
            <label htmlFor="description" className="custom-label">
              {t("enter-course-description-label")}
            </label>
            <div className="mt-2">
              <textarea
                id="description"
                ...
                placeholder={t("enter-course-description-placeholder")}
              />
            </div>
            <Button
