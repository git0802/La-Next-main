        ...
        apiCall('/quizzes')
          ...
          .then((_data: Quiz[] | string) => {
            if (typeof _data === "string") {
              ...
              if (!_data.length) {
                showModal("no-quizzes", 0, "create-a-quiz", "create-quiz");
              }
              setQuizzes(_data); // set active quiz to the quiz returned from the api
            }
          })
          .catch((e) => {
            showModal("quizlist-fail", 0, "go-home", "home");
...
export default withAuthorization(YourQuizzesPage);